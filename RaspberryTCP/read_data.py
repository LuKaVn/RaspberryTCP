...
#list_String_IVT1=[20,22,22,19,18,22,22,20,20,19,22,19,22,22,22]
list_Data_F=[]
...
def Alarm(on_Alarm,off_Alarm):
    if on_Alarm == True:
        ...
        blynk.email("cuonglbq@geccom.vn", alarm_msg , "https://www.dropbox.com/s/qcz2n4awpasmeaz/QLVH.HD_06.pdf?dl=0")
        on_Alarm = False
    if off_Alarm == True:
